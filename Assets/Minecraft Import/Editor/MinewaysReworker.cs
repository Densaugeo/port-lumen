...
public static class Globals {
  ...
  new Dictionary<string, (bool, bool)> {
    ...
    { "Birch_Fence"                     , (true , false) },
    { "Birch_Leaves"                    , (true , true ) },
    { "Birch_Log"                       , (true , false) },
    { "Birch_Pressure_Plate"            , (false, false) },
    { "Birch_Slab"                      , (true , false) },
    { "Birch_Stairs"                    , (true , false) },
    { "Birch_Trapdoor"                  , (true , false) },
    { "Birch_Wall_Sign"                 , (false, false) },
    { "Birch_Wood_Planks"               , (true , false) },
    { "Black_Carpet"                    , (true , false) },
    { "Black_Concrete"                  , (true , false) },
    { "Black_Glazed_Terracotta"         , (true , false) },
    ...
    { "Blue_Glazed_Terracotta"          , (true , false) },
    ...
    { "Chiseled_Tuff"                   , (true , false) },
    { "Chiseled_Tuff_Bricks"            , (true , false) },
    { "Clay"                            , (true , false) },
    { "Closed_Eyeblossom"               , (false, true ) },
    { "Coal_Ore"                        , (true , false) },
    ...
    { "Cyan_Glazed_Terracotta"          , (true , false) },
    ...
    { "Double_Deepslate_Brick_Slab"     , (true , false) },
    { "Double_Deepslate_Tile_Slab"      , (true , false) },
    { "Double_Exposed_Cut_Copper_Slab"  , (true , false) },
    { "Double_Mangrove_Slab"            , (true , false) },
    { "Double_Oak_Slab"                 , (true , false) },
    { "Double_Oxidized_Cut_Copper_Slab" , (true , false) },
    { "Double_Polished_Blackstone_Brick_Slab", (true, false) },
    { "Double_Polished_Diorite_Slab"    , (true , false) },
    { "Double_Quartz_Slab"              , (true , false) },
    ...
    { "Gray_Glazed_Terracotta"          , (true , false) },
    { "Gray_Wool"                       , (true , false) },
    // Name                                coll   cut
    { "Green_Glazed_Terracotta"         , (true , false) },
    ...
    { "Inverted_Daylight_Sensor"        , (true , false) },
    { "Iron_Bars"                       , (true , true ) },
    { "Iron_Chain"                      , (true , true ) },
    { "Iron_Door"                       , (false, true ) },
    { "Iron_Ore"                        , (true , false) },
    { "Iron_Trapdoor"                   , (true , true ) },
    { "Jukebox"                         , (true , false) },
    { "Jungle_Fence"                    , (true , false) },
    { "Jungle_Leaves"                   , (true , true ) },
    { "Kelp"                            , (false, true ) },
    { "Ladder"                          , (true , true ) },
    { "Lantern"                         , (true , true ) },
    { "Lapis_Lazuli_Ore"                , (true , false) },
    { "Large_Fern"                      , (false, true ) },
    ...
    { "Lily_Pad"                        , (true , true ) },
    { "Lime_Glazed_Terracotta"          , (true , false) },
    { "Lime_Shulker_Box"                , (true , false) },
    { "Lit_Candle"                      , (true , true ) },
    { "Lit_Candle__16"                  , (true , true ) },
    { "Lit_Candle__32"                  , (true , true ) },
    { "Lit_Candle__48"                  , (true , true ) },
    { "Loom"                            , (true , false) },
    { "Magenta_Wall_Banner"             , (false, false) },
    { "Magma_Block"                     , (true , false) },
    { "Mangrove_Fence"                  , (true , false) },
    { "Mangrove_Planks"                 , (true , false) },
    { "Mangrove_Pressure_Plate"         , (true , false) },
    { "Mangrove_Slab"                   , (true , false) },
    { "Melon"                           , (true , false) },
    { "Melon_Stem_age_7"                , (false, true ) },
    { "Moss_Block"                      , (true , false) },
    { "Moss_Carpet"                     , (true , false) },
    { "Mossy_Cobblestone"               , (true , false) },
    { "Mossy_Cobblestone_Slab"          , (true , false) },
    { "Mossy_Cobblestone_Stairs"        , (true , false) },
    { "Mossy_Cobblestone_Wall"          , (true , false) },
    { "Mossy_Stone_Bricks"              , (true , false) },
    { "Mossy_Stone_Brick_Stairs"        , (true , false) },
    { "Mossy_Stone_Brick_Wall"          , (true , false) },
    { "Mud"                             , (true , false) },
    { "Mud_Bricks"                      , (true , false) },
    { "Mud_Brick_Stairs"                , (true , false) },
    ...
    { "Observer"                        , (true , false) },
    { "Obsidian"                        , (true , false) },
    { "Open_Eyeblossom"                 , (false, true ) },
    { "Orange_Glazed_Terracotta"        , (true , false) },
    ...
    { "Oxidized_Copper_Lantern"         , (true , true ) },
    { "Oxidized_Copper_Trapdoor"        , (true , true ) },
    { "Oxidized_Cut_Copper"             , (true , false) },
    { "Oxidized_Cut_Copper_Slab"        , (true , false) },
    { "Oxidized_Cut_Copper_Stairs"      , (true , false) },
    { "Oxidized_Lightning_Rod"          , (true , false) },
    { "Packed_Ice"                      , (true , false) },
    { "Packed_Mud"                      , (true , false) },
    { "Pale_Oak_Slab"                   , (true , false) },
    { "Pale_Oak_Shelf"                  , (true , false) },
    { "Pale_Oak_Stairs"                 , (true , false) },
    { "Pale_Oak_Trapdoor"               , (true , false) },
    { "Pale_Oak_Wall_Sign"              , (false , false) },
    { "Peony"                           , (false, true ) },
    { "Pink_Glazed_Terracotta"          , (true , false) },
    { "Pink_Petals"                     , (false, true ) },
    { "Pink_Tulip"                      , (false, true ) },
    { "Piston"                          , (true , false) },
    { "Piston_Head"                     , (true , false) },
    { "Pitcher_Plant"                   , (false, true ) },
    { "Podzol"                          , (true , false) },
    { "Pointed_Dripstone"               , (true , true ) },
    { "Polished_Andesite"               , (true , false) },
    { "Polished_Andesite_Stairs"        , (true , false) },
    { "Polished_Blackstone_Brick_Slab"  , (true , false) },
    { "Polished_Blackstone_Brick_Wall"  , (true , false) },
    { "Polished_Blackstone_Bricks"      , (true , false) },
    { "Polished_Blackstone_Button"      , (false, false) },
    { "Polished_Deepslate"              , (true , false) },
    { "Polished_Deepslate_Slab"         , (true , false) },
    { "Polished_Deepslate_Stairs"       , (true , false) },
    { "Polished_Deepslate_Wall"         , (true , false) },
    ...
    { "Potted_Blue_Orchid"              , (true , false) },
    { "Potted_Bamboo"                   , (true , false) },
    { "Potted_Brown_Mushroom"           , (true , false) },
    { "Potted_Cherry_Sapling"           , (true , false) },
    { "Potted_Cornflower"               , (true , false) },
    { "Potted_Dandelion"                , (true , false) },
    { "Potted_Dead_Bush"                , (true , false) },
    ...
    { "Redstone_Lamp_(inactive)"        , (true , false) },
    ...
    { "Smooth_Quartz_Slab"              , (true , false) },
    { "Smooth_Quartz_Stairs"            , (true , false) },
    ...
    { "Spruce_Wall_Hanging_Sign"        , (false, false) },
    ...
    { "Stripped_Birch_Log"              , (true , false) },
    { "Stripped_Cherry_Log"             , (true , false) },
    { "Stripped_Cherry_Wood"            , (true , false) },
    ...
    { "Tuff"                            , (true , false) },
    { "Tuff_Bricks"                     , (true , false) },
    { "Tuff_Brick_Stairs"               , (true , false) },
    { "Tuff_Brick_Wall"                 , (true , false) },
    { "Vines"                           , (false, true ) },
    { "Wall_Banner"                     , (false, false) },
    { "Warped_Fungus"                   , (false, true ) },
    { "Warped_Wall_Sign"                , (false, false) },
    { "Warped_Wart_Block"               , (true , false) },
    { "Waxed_Block_of_Copper"           , (true , false) },
    { "Waxed_Chiseled_Copper"           , (true , false) },
    { "Waxed_Copper_Bars"               , (true , true ) },
    { "Waxed_Copper_Bulb"               , (true , false) },
    { "Waxed_Copper_Door"               , (false, true ) },
    { "Waxed_Copper_Grate"              , (true , true ) },
    { "Waxed_Copper_Lantern"            , (true , true ) },
    { "Waxed_Copper_Trapdoor"           , (true , true ) },
    { "Waxed_Cut_Copper"                , (true , false) },
    { "Waxed_Cut_Copper_Stairs"         , (true , false) },
    ...
    { "Weathered_Lightning_Rod"         , (true , false) },
    { "Wheat"                           , (false, true ) },
    { "White_Stained_Glass"             , (true , false) },
    { "White_Carpet"                    , (true , false) },
    { "White_Concrete"                  , (true , false) },
    { "White_Glazed_Terracotta"         , (true , false) },
    { "White_Shulker_Box"               , (true , false) },
    { "White_Tulip"                     , (false, true ) },
    { "White_Wool"                      , (true , false) },
    { "Wildflowers"                     , (false, true ) },
    { "Yellow_Stained_Glass"            , (true , false) },
  };
}
